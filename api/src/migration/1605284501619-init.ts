...
export class init1605284501619 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cryptos" ("id" SERIAL NOT NULL, "label" character varying NOT NULL, CONSTRAINT "PK_ef652cc06c83b810bc7775dde08" PRIMARY KEY ("id"))`);
